...
public abstract class KeyedMultiInputOperator8<IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, OUT>
    extends BaseMultiInputKeyedOperator<OUT> {

  private static final long serialVersionUID = 1L;

  protected KeyedMultiInputOperator8(StreamOperatorParameters<OUT> params) {
    super(params, 8);
    addInputHandler(in1);
    addInputHandler(in2);
    addInputHandler(in3);
