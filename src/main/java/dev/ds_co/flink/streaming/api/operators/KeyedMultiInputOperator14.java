...
public abstract class KeyedMultiInputOperator14<
        IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, IN9, IN10, IN11, IN12, IN13, IN14, OUT>
    extends BaseMultiInputKeyedOperator<OUT> {

  private static final long serialVersionUID = 1L;

  protected KeyedMultiInputOperator14(StreamOperatorParameters<OUT> params) {
    super(params, 14);
    addInputHandler(in1);
    addInputHandler(in2);
    addInputHandler(in3);
