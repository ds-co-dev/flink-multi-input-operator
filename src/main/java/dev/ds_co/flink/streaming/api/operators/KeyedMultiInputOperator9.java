...
public abstract class KeyedMultiInputOperator9<IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, IN9, OUT>
    extends BaseMultiInputKeyedOperator<OUT> {

  private static final long serialVersionUID = 1L;

  protected KeyedMultiInputOperator9(StreamOperatorParameters<OUT> params) {
    super(params, 9);
    addInputHandler(in1);
    addInputHandler(in2);
    addInputHandler(in3);
