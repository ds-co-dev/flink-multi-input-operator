...
import dev.ds_co.flink.streaming.api.operators.KeyedMultiInputOperator12;
...
public class KeyedMultiInputOperatorTestHarness12<
        K, IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, IN9, IN10, IN11, IN12, OUT>
    extends MultiInputStreamOperatorTestHarness<OUT> {

  public KeyedMultiInputOperatorTestHarness12(
      Class<
              ? extends
                  KeyedMultiInputOperator12<
