...
import dev.ds_co.flink.streaming.api.operators.KeyedMultiInputOperator9;
...
public class KeyedMultiInputOperatorTestHarness9<
        K, IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, IN9, OUT>
    extends AbstractStreamOperatorTestHarness<OUT> {

  public KeyedMultiInputOperatorTestHarness9(
      Class<? extends KeyedMultiInputOperator9<IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, IN9, OUT>>
          operatorClass,
