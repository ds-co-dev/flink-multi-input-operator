...
import dev.ds_co.flink.streaming.api.operators.KeyedMultiInputOperator10;
...
public class KeyedMultiInputOperatorTestHarness10<
        K, IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, IN9, IN10, OUT>
    extends MultiInputStreamOperatorTestHarness<OUT> {

  public KeyedMultiInputOperatorTestHarness10(
      Class<
              ? extends
                  KeyedMultiInputOperator10<IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, IN9, IN10, OUT>>
          operatorClass,
