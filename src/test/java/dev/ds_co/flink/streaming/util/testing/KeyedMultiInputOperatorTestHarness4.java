...
public class KeyedMultiInputOperatorTestHarness4<K, IN1, IN2, IN3, IN4, OUT>
    extends AbstractStreamOperatorTestHarness<OUT> {

  public KeyedMultiInputOperatorTestHarness4(
      Class<? extends KeyedMultiInputOperator4<IN1, IN2, IN3, IN4, OUT>> operatorClass,
