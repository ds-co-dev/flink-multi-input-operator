...
import dev.ds_co.flink.streaming.api.operators.KeyedMultiInputOperator11;
...
public class KeyedMultiInputOperatorTestHarness11<
        K, IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, IN9, IN10, IN11, OUT>
    extends AbstractStreamOperatorTestHarness<OUT> {

  public KeyedMultiInputOperatorTestHarness11(
      Class<
              ? extends
                  KeyedMultiInputOperator11<
